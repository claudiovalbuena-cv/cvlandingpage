                        ...
                        <div className="bg-white border border-gray-200 p-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                                {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((num) => (
                                    <div key={num}>
                                        <label className="block text-sm font-medium mb-2">Gallery Image {num}</label>
                                        <div className="space-y-3">
                                            <input
                                                type="text"
                                                name={`gallery_image_${num}`}
                                                value={(settings as any)[`gallery_image_${num}`]}
                                                onChange={handleChange}
                                                className="w-full px-4 py-3 border border-gray-300"
                                                placeholder="Image URL..."
                                            />
                                            <div className="relative">
                                                <label className="cursor-pointer bg-white border border-gray-300 px-4 py-2 text-sm font-medium hover:bg-gray-50 flex items-center justify-center gap-2 w-full">
                                                    ...
                                                    <input
                                                        ...
                                                        className="hidden"
                                                        accept="image/*"
                                                        onChange={(e) => handleGalleryUpload(e, num)}
                                                        disabled={isUploading}
                                                    />
                                                </label>
                                            </div>
                                            {(settings as any)[`gallery_image_${num}`] && (
                                                <div className="aspect-square border border-gray-200 overflow-hidden bg-gray-50 relative">
                                                    <img
                                                        src={(settings as any)[`gallery_image_${num}`]}
                                                        alt={`Gallery ${num}`}
                                                        className="w-full h-full object-cover"
                                                    />
                                                </div>
